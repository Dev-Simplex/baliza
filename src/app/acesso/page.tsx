...
export default function PaginaDeAcesso() {
  return (
    ...
    >
      ...
      <h1 className="mt-3 t-secao text-2xl">Digite seu código de acesso</h1>
      ...
      <p className="mt-6 t-legenda leading-relaxed text-muted-foreground">
        Já respondeu? Não é preciso responder de novo: o código vale uma vez só e
        o acompanhamento é feito pela empresa que te chamou.
      </p>
    </MolduraPublica>
  );
}
