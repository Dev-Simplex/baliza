...
export default async function PaginaPublicaDaVaga({
  ...
  return (
    <MolduraPublica
      ...
      rodape={
        <>
          Seus dados são usados apenas neste processo seletivo e apagados no
          prazo informado pela empresa. Você pode pedir a exclusão a qualquer
          momento.
        </>
      }
    >
      ...
      <h1 className="mt-3 t-titulo">{vaga.title}</h1>
      ...
      {aberta ? (
        // O formulário ganha cartão próprio: ele é a tarefa da tela, e um bloco
        // branco sobre o osso separa "ler sobre a vaga" de "começar".
        <div className="mt-9 rounded-2xl border bg-card p-5 shadow-baixa sm:p-6">
          <h2 className="t-cartao">Comece pelo mapeamento comportamental</h2>
          <p className="mt-1.5 t-corpo-sm leading-relaxed text-muted-foreground">
            ...
            celular. Não é prova, não precisa criar conta, e o resultado vai
            direto para quem conduz o processo.
          </p>
        ...
        <div className="mt-9 rounded-2xl border border-dashed px-5 py-7 text-center">
          <p className="t-cartao">Esta vaga é por convite</p>
          <p className="mt-1.5 t-corpo-sm leading-relaxed text-muted-foreground">
        ...
        <div className="mt-9 rounded-2xl border border-dashed px-5 py-7 text-center">
          <p className="t-cartao">Esta vaga já foi encerrada</p>
          <p className="mt-1.5 t-corpo-sm leading-relaxed text-muted-foreground">
            A empresa não está mais recebendo respostas por aqui. Se você
            respondeu antes do encerramento, quem conduz o processo continua com
            o seu resultado.
          </p>
        </div>
      )}
